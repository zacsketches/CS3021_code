...
void testPet() {
	...
	Pet* n12 = new Pet("1212", "twelve",  12, 13.5);
	Pet* n13 = new Pet("1313", "thirteen",  12, 13.5);
	Pet* n14 = new Pet("1414", "fourteen",  12, 13.5);
